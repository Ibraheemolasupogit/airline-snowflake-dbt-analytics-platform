...
- Milestone 21 and later milestones - planned
...
Planned (Milestone 21 onward):

- voucher application
- production dbt contracts and incremental model design
- state-based CI (`dbt build --select state:modified+`)
- exposures and semantic-layer definitions
